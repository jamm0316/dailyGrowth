package com.todoservice.dailygrowth.domain.task.application;
...
import com.todoservice.dailygrowth.domain.task.presentation.dto.*;
...
public class TaskService {
    ...
    public List<TaskSummaryResponse> summaryListTask(Long userId) {
